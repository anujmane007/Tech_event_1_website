...
const text =
	"This year, we are organizing a technical event on placement preparation for SY/TY/BTech students from CSE/ENTC/MECH/CIVIL. Please Click on the Register Button for Registration.";
			...
			<div className='container'>
				<div className='hero__content'>
					<div>
						...
						<h1>Sambhav 2K23</h1>
						<span>By CSESA Technical Team</span>
